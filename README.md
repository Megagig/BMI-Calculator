...
**BMI ** A simple Body Mass Index calculator to determine the body mass of a patient in clinical diagnosis of Obesity
...
- [Live Demo Link](https://anthonyobi-bmi-calculator.netlify.app/)
